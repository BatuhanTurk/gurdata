...
class UserProfileForm(forms.Form):
    ...
    old_password = forms.CharField(label='Eski Şifreniz',required=False, widget=forms.PasswordInput(attrs={'class': 'form-control', 'autocomplete': 'new-password', 'aria-autocomplete': 'none', 'placeholder': ''}))
    new_password = forms.CharField(label='Şifreniz',required=False, widget=forms.PasswordInput(attrs={'class': 'form-control', 'autocomplete': 'new-password', 'aria-autocomplete': 'none', 'placeholder': ''}))
    confirm_password = forms.CharField(label='Şifrenizi Onaylayın',required=False, widget=forms.PasswordInput(attrs={'class': 'form-control', 'autocomplete': 'new-password', 'aria-autocomplete': 'none', 'placeholder': ''}))
