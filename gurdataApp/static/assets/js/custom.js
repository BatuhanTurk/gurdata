...
$(document).ready(function () {
    ...
    // let overlay = document.querySelector(".closesidebar");
    ...
    if (toggleButton){
    function toggleMenu() {
        const menuDiv = document.getElementById('menubtns');
...
function pushHideButton(id) {
    let txtPass = document.getElementById(id);
    let btnEye = document.getElementById("buttonEye-"+id);
    if (txtPass.type === "text") {
        txtPass.type = "password";
        btnEye.className = "eyespan eye-off";
    } else {
        txtPass.type = "text";
        btnEye.className = "eyespan eye";
    }
}
